...
# ─── 定数 ────────────────────────────────────────────────────────────
#
# Other games adaptation:
#   This script works with any Steam Workshop game by changing APP_ID.
#   The ACF format (appworkshop_{APP_ID}.acf) is common across all games.
#   You may also need to adjust get_mod_name() for game-specific metadata.
#   Steam App IDs can be found at: https://store.steampowered.com/app/{APP_ID}
#
#   Examples:
...
# ─── Mod情報取得 ─────────────────────────────────────────────────────
#
# Game-specific: This function reads Project Zomboid's mod.info format.
# For other games, adapt the metadata lookup. Common patterns:
#   - Stellaris / Cities: descriptor.mod (key="value" format)
#   - RimWorld: About/About.xml (<name> tag)
#   - Don't Starve Together: modinfo.lua (name = "...")
# If unsure, the fallback (ID display) works for any game.
